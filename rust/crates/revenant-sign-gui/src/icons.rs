...
pub(crate) use egui_phosphor::regular::{
    ...
    EYE_SLASH as INVISIBLE, FILE_PDF as PDF, IMAGE, KEY as LOGIN, PEN_NIB as SIGN,
    PLUGS_CONNECTED as CONNECT, SHIELD_CHECK as VERIFY, SIGN_OUT as LOG_OUT, USER as NAME,
};
